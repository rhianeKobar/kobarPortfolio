...
export default function About() {
	return (
		<div className='about' id="about">
			<p>
				Hey! I'm a Front-end developer and UI Designer. Recently I completed the Maker's Academy 
			...
			<p>
				Outside of coding, I play bass, love fermentation and gardening, DIY and gaming 
				(add me on switch).
			</p>		
		</div>
	)
